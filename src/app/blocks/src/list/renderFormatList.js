...
class _FormatRowMixin {
  ...
  getRenderName() {
    ...
    if (this.list.NLSLocalized.escaDataset && title == null) {
      if (downloadURI != null && downloadURI !== '') {
        return this.list.NLSLocalized.escaDataset.defaultDownloadTitle;
      } else if (source != null && source !== '') {
        return this.list.NLSLocalized.escaDataset.autoGeneratedAPI;
      }
      return this.list.NLSLocalized.escaDataset.defaultAccessTitle;
    }
    return title;
  }
