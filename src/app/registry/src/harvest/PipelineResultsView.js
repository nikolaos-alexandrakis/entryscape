...
define([
...
], (declare, _WidgetsInTemplateMixin, _WidgetBase, _TemplatedMixin) =>
  declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, NLSMixin.Dijit], {
    ...
    async renderJobEntries(onlyLockButton = false) {
      ...
      // const title = i18n.renderNLSTemplate(Object.entries(this.nlsBundles[0])[0][1], 'harvestingLatestX', pipeResults.length);
